...
export default async function Home() {
  ...
  const contactData = await getMarkdownDataBySlug<ContactData>('site', 'contact');

  // Handle case where data might be missing
  if (!heroData || !contactData) {
    throw new Error('Required content is missing. Make sure you have hero and contact markdown files.');
  }
