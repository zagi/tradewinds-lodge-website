    ...
    <>
      <Card className="overflow-hidden group">
        <div className="relative h-64 overflow-hidden">
          ...
          {room.badge && (
            <Badge className="absolute top-3 right-3 bg-teal-500 text-white z-30">
              {room.badge}
            </Badge>
          )}
        ...
        <CardFooter className="p-4 flex justify-between items-center bg-gray-50 dark:bg-gray-800">
          ...
          <Badge className={`${room.status === 'Available Now' ? 'bg-green-600' : 'bg-red-600'}`}>
            {room.status}
          </Badge>
        </CardFooter>
      </Card>
          ...
          <div className="grid md:grid-cols-2 h-full">
            ...
            <div className="p-6 flex flex-col">
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="font-medium">{room.size} {room.sizeUnit}</p>
                  </div>
                </div>
                <div className="flex items-center">
              ...
              <div className="border-t border-gray-100 pt-4 mb-6">
                ...
                <div className="text-gray-600 dark:text-gray-100 prose-sm" dangerouslySetInnerHTML={{ __html: room.content }} />
              </div>
